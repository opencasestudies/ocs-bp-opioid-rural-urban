...
Note that if you have trouble with the data import from the API, we have saved files after getting the data from the API located in the `data/imported` directory of our [GitHub repository](https://github.com/opencasestudies/ocs-bp-opioid-rural-urban/).
...
In case an instructor or learner wants to start here we will load the imported data. You can find these files on our [GitHub repository](https://github.com/opencasestudies/ocs-bp-opioid-rural-urban/) with the same file structure as we demonstrated above.
...
This [link](https://www.census.gov/library/publications/2011/compendia/usa-counties-2011/file-layout.html)  [link](https://www2.census.gov/library/publications/2011/compendia/usa-counties/excel/Mastdata.xls) explains what each of the column names indicate.
...
In case an instructor or learner wants to start here we will load the wrangled data. You can find these files on our [GitHub repository](https://github.com/opencasestudies/ocs-bp-opioid-rural-urban/) with the same file structure as we demonstrated above.
...
Nice, now we have a pretty easy to interpret table, but we can make it even easier to quickly assess trends in the data using the `formattable` package. 
