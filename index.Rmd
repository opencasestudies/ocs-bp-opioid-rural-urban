...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-D23TSPK2DS"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-D23TSPK2DS');
</script>
...
write.csv(land, file = here::here("data", "land_area.csv"))
save(land, file =  here::here("data", "land_area.rda"))
```
...
load(here::here("data", "land_area.rda"))
