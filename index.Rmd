...
Suppose we have a data set called `mydata`. Using functions that we talked about earlier, check if there are missing data for the variables. If so, which observation(s) have missing value(s)?
