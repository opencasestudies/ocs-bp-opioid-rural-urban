...
If you are setting up this case study, run the following once to install any of these packages that you do not already have. The reading-metrics packages are optional; install them only if you would like those tables to appear when rendering.

```{r, eval=FALSE}
install.packages(c(
  "naniar", "formattable", "Hmisc", "ggiraph", "patchwork",
  "directlabels", "usdata", "OCSdata"
))

# Optional packages for the reading-time and readability tables
install.packages(c("wordcountaddin", "read.so"))

# ggpol is installed from GitHub
