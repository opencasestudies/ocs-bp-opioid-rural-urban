...
We will also start using the `%>%` pipe of the `dplyr` package for our assignments.
...
We are going to use the `%>%` pipe operator to use the `annualDosage` as our input and perform subsequent steps to create an updates version of the tibble.
