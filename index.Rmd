...
write.csv(land, file = here::here("data", "simple_import", "land_area.csv"))
```
...
```{r, eval = FALSE, echo = FALSE}
# For instructors who want to do a simpler version of import
write.csv(county_pop, file = here::here("data", "Simple_import", "county_pop_arcos.csv"))
```
...
# for instructors who want to do a simpler version of import
write.csv(annualDosage, file = here::here("data", "Simple_import", "county_annual.csv"))
```
...
write.csv(monthlyDosage, 
          file = here::here("data","Simple_import", "county_monthly.csv"))

save(monthlyDosage, 
     file =  here::here("data", "imported", "county_monthly.rda"))
```
