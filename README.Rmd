...
The data for this case study is available through the [Washington Post ARCOS API client and documentation](https://github.com/wpinvestigative/arcos). 
